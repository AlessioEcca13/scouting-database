          ...
          <div className="flex items-start gap-3 flex-1">
            ...
            {player.profile_image ? (
              <img 
                ...
                alt={player.name}
                className="w-20 h-20 rounded-lg object-cover border-2 border-purple-200 shadow-md"
                onError={(e) => {
              ...
              <div className="w-20 h-20 rounded-lg bg-gradient-to-br from-purple-400 to-blue-500 flex items-center justify-center text-white font-bold text-xl border-2 border-purple-200 shadow-md">
                {player.name?.[0] || '?'}
              </div>
            )}
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-1">
                ...
                {isSignalazione && (
                  <span className="px-2 py-0.5 rounded-full text-xs font-bold bg-orange-100 text-orange-700 border border-orange-300 animate-pulse">
                    ⚠️ DA VALUTARE
                  </span>
                )}
              </div>
              ...
              {player.priority && (
                <span className={`inline-block mt-1 px-3 py-1 rounded-full text-xs font-bold border-2 ${getPriorityColor(player.priority)} shadow-sm`}>
        ...
        <div className="border-t pt-4">
          ...
          {isSignalazione && onAddReport && (
            <button
              ...
              className="w-full bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white py-3 rounded-lg font-bold transition-all flex items-center justify-center gap-2 mb-3 shadow-lg transform hover:scale-105"
            >
